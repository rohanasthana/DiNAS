...
class NASBenchVisualization:
    def __init__(self, dataset_infos,remove_h):
    ...
    def mol_from_graphs(self, node_list, adjacency_matrix):
        ...
        #conv = {'input': 0, 'maxpool3x3': 1, 'conv1x1-bn-relu': 2, 'conv3x3-bn-relu': 3, 'output': 4}
        for i in range(len(node_list)):
            if node_list[i] == -1:
                continue
            a = Chem.Atom(conv[atom_decoder[int(node_list[i])]])
...
class NASBench201Visualization:
    def __init__(self, dataset_infos,remove_h):
        self.remove_h = remove_h
        self.dataset_infos = dataset_infos
    ...
    def mol_from_graphs(self, node_list, adjacency_matrix):
        ...
        node_to_idx = {}
        #print(node_list)
        conv = {'inp': 'C', 'out': 'N', '1x1': 'O', '3x3':'F', 'ap':'I', 'skip': 'S', 'none': 'Cl'}
        #conv = {'input': 0, 'maxpool3x3': 1, 'conv1x1-bn-relu': 2, 'conv3x3-bn-relu': 3, 'output': 4}
        for i in range(len(node_list)):
            if node_list[i] == -1:
                continue
...
class NASBenchNLPVisualization:
    def __init__(self, dataset_infos,remove_h):
        self.remove_h = remove_h
        self.dataset_infos = dataset_infos
    ...
    def mol_from_graphs(self, node_list, adjacency_matrix):
        ...
        node_to_idx = {}
        #print(node_list)
        conv = {'out': 'C', 'in': 'N', 'sigm': 'O', 'tanh': 'F', 'lrelu': 'B', 'sum':'Al','prod':'I','linear':'S','blend':'Cl'}
        #conv = {'input': 0, 'maxpool3x3': 1, 'conv1x1-bn-relu': 2, 'conv3x3-bn-relu': 3, 'output': 4}
        for i in range(len(node_list)):
            if node_list[i] == -1:
                continue
...
class NASBench301Visualization:
    def __init__(self, dataset_infos,remove_h):
        self.remove_h = remove_h
        self.dataset_infos = dataset_infos
    ...
    def mol_from_graphs(self, node_list, adjacency_matrix):
        ...
        node_to_idx = {}
        #print(node_list)
        conv = {'output': 'C', 'input': 'N', 'input_1': 'O', 'identity': 'F', 'max_pool_3x3': 'B', 'avg_pool_3x3':'Al', 'Si':6,'sep_conv_3x3':'P','sep_conv_5x5':'S','dil_conv_3x3':'Cl','dil_conv_5x5':'As'}
        #conv = {'input': 0, 'maxpool3x3': 1, 'conv1x1-bn-relu': 2, 'conv3x3-bn-relu': 3, 'output': 4}
        for i in range(len(node_list)):
            if node_list[i] == -1:
                continue
...
class NASBenchImageNetVisualization:
    def __init__(self, dataset_infos,remove_h):
        self.remove_h = remove_h
        self.dataset_infos = dataset_infos
