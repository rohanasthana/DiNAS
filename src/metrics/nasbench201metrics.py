...
from src.analysis.rdkit_functions201 import compute_molecular_metrics
...
class TrainNASBench201MetricsDiscrete(nn.Module):
    def __init__(self, dataset_infos):
        super().__init__()
...
class SamplingNASBench201Metrics(nn.Module):
