...
from src.analysis.rdkit_functions301 import compute_molecular_metrics
...
class TrainNASBench301MetricsDiscrete(nn.Module):
    def __init__(self, dataset_infos):
        super().__init__()
...
class SamplingNASBench301Metrics(nn.Module):
