...
from src.analysis.rdkit_functionsImageNet import compute_molecular_metrics
...
class Inp1CE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class IdenCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class M3x3CE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class A3x3CE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
...
class SepC3x3CE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
        
class SepC5x5CE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
        
class DC3x3CE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
        
class DC5x5CE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
...
class NodeMetrics(MetricCollection):
    def __init__(self, dataset_infos):
        ...
        class_dict = {'output': OutCE, 'input': InpCE, 'input_1': Inp1CE, 'identity': IdenCE, 'max_pool_3x3': M3x3CE, 'avg_pool_3x3':A3x3CE, 'skip_connect':SkipCE,'sep_conv_3x3':SepC3x3CE,'sep_conv_5x5':SepC5x5CE,'dil_conv_3x3':DC3x3CE,'dil_conv_5x5':DC5x5CE}
...
class TrainNASBenchImageNetMetricsDiscrete(nn.Module):
    def __init__(self, dataset_infos):
        super().__init__()
...
class SamplingNASBenchImageNetMetrics(nn.Module):
