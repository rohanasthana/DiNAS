...
from src.analysis.rdkit_functionsNLP import compute_molecular_metrics
...
class sigmCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class tanhCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class lreluCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class sumCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
        
class prodCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
        
class linearCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
        
class blendCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
...
class NodeMetrics(MetricCollection):
    def __init__(self, dataset_infos):
        ...
        class_dict = {'out': OutCE, 'in': InpCE, 'sigm': sigmCE, 'tanh': tanhCE, 'lrelu': lreluCE, 'sum':sumCE, 'prod':prodCE,'linear':linearCE,'blend':blendCE}
...
class TrainNASBenchNLPMetricsDiscrete(nn.Module):
    def __init__(self, dataset_infos):
        super().__init__()
...
class SamplingNASBenchNLPMetrics(nn.Module):
