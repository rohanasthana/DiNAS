...
class NodeMetrics(MetricCollection):
    def __init__(self, dataset_infos):
        ...
        class_dict = {'input': InpCE, 'conv1x1-bn-relu': C1x1CE, 'conv3x3-bn-relu': C3x3CE, 'maxpool3x3': M3x3CE, 'output': OutCE}
...
class TrainNASBenchMetricsDiscrete(nn.Module):
    def __init__(self, dataset_infos):
        super().__init__()
...
class SamplingNASBenchMetrics(nn.Module):
