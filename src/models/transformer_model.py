...
class GraphTransformer(nn.Module):
    ...
    def __init__(self, n_layers: int, input_dims: dict, hidden_mlp_dims: dict, hidden_dims: dict,
        ...
        self.in2hidden = nn.Linear(2*hidden_dims['dx'], hidden_dims['dx'])
        self.in2output = nn.Linear(2*hidden_dims['dx'], hidden_dims['dx'])
        ...
        self.mlp_in_y = nn.Sequential(nn.Linear(1, hidden_mlp_dims['y']), act_fn_in,
