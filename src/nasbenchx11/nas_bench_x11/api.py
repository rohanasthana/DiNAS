...
def load_ensemble(ensemble_parent_directory):
    ...
    ensemble_member_dirs = ["/home/asthana/Documents/GenerativeNAS/AG-Net-main/datasets/nasbenchx11/checkpoints/ensemble_member_0","/home/asthana/Documents/GenerativeNAS/AG-Net-main/datasets/nasbenchx11/checkpoints/ensemble_member_1","/home/asthana/Documents/GenerativeNAS/AG-Net-main/datasets/nasbenchx11/checkpoints/ensemble_member_2"]
    print(ensemble_member_dirs)
