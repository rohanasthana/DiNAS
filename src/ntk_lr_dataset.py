...
dataset =  NASBench301_self.Dataset(batch_size=16, sample_size=100000, only_prediction=True)
...
torch.save(conditional_train_data, '/home/asthana/Documents/DiGress/DiGress/data/cifar10/lr_ntl_cifar10')
